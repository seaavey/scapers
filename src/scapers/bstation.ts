...
export const search = async (query: string, page: number = 1): Promise<SearchResponse | undefined> => {
  try {
...
export const download = async (url: string, quality: string = "480P"): Promise<DownloadResponse | undefined> => {
  try {
